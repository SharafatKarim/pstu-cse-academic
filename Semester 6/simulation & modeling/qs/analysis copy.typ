...
- Describe and illustrate the transient and steady-state behaviors of a stochastic process. \(03) _\[2023 Final\]_
- Describe and illustrate transient and steady-state behavior of a stochastic process. \(04) _\[2022 Final \(Session 19-20)\]_
- What is the necessity of statistical analysis with simulation output data? \(03) _\[2023 Final\]_
- What is the necessity of statistical analysis on simulation output data? \(04) _\[2022 Final \(Session 19-20)\]_
- Why stochastic process is used to simulate the output data? \(07/05) _\[2021 Final\]\[2022 Final \(Session 19-20)\]_
- Derive the mathematical formulation in a good estimate of the mean of the system using both validation and output analysis. \(06) _\[2022 Final \(Session 19-20)\]_
- Compute variance and covariance based on a set of random variates. \(07) _\[2021 Final\]_
- How to compute variance, covariance, and correlation for simulation study? \(05) _\[2023 Final\]\[2022 Final \(Session 19-20)\]_
- Illustrate correlation function of the process of delays in queue #mi("D_1, D_2, \\dots") for the M/M/1 queue. \(05) _\[2023 Final\]\[2022 Final \(Session 19-20)\]\[2021 Final\]_
...
#block(
  ...
  #align(right)[
    #set text(fill: rgb("b8860b"), style: "italic", size: 8pt)
