...
* Define the following terminologies: i) System ii) Model iii) Simulation iv) Analytical solution. Demonstrate different ways in which a system might be studied. (03) *[2019-20 Mid][2018-19 Final]*

* What are the steps of simulation for a single-server queueing system? Describe the problem statement and intuitive explanation of a single-server queueing system. (05) *[2019-20 Mid][2018-19 Final]*
...
* What is the necessity of statistical analysis with simulation output data? Describe and illustrate the transient and steady-state behaviors of a stochastic process. (03) *[2020-21 Final][2019-20 Final]*
