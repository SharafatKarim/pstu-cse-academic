...
class ChattingServer:
    ...
    def handle_client(self, client_socket, client_address):
        ...
        try:
            ...
            client_socket.send("✅ Connected to chat server! Type '/help' for commands.".encode('utf-8'))
            
            print(f"👤 {nickname} ({client_address}) joined the chat. Total users: {len(self.clients)}")
